...
function displayPics() {
    while (viewed.length < 6) {
        ...
        while (!viewed.includes(rando)) {
            viewed.push(rando);
            // console.log(rando); //the line we delete! I console it inside the function
        }
    }

    // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the variable declaration from `var to `let`.
    // PUT YOUR RESPONSE IN THIS COMMENT: the "rando" is declared inside the function "displayPics()" so it is a local variable, the error was "undefined" because the console was outside the function, we can solve this by butting " console.log(rando); " inside the function or make  " let rando = makeRandom();" as a global variable. or delete the line itself without efficting in the code.
    console.log(viewed);
