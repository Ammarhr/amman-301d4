...
//    "this"  reffers to the properties of the object "joe" and its values of the constrcter "Student".
// 2. What is "this" when joe.scopeArrow() is invoked?
//    "this"   reffers to the windows object
// 3. Explain why "this" is different when an arrow function is used.
//   in case of useing "arrow functions": it  doesn't bind their own "this", instead, they inherit the one from the parent scope(refers to the originating context). wich is the window or a global object.